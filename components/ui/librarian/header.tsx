...
import { Input } from "../parent/input"
    ...
    <header className="bg-slate-800 border-b border-slate-700">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium hidden lg:block">Maria Smith</span>
      ...
      {title && (
        <div className="relative h-32 lg:h-48 overflow-hidden">
          ...
          <div className="relative px-4 lg:px-6 py-6 lg:py-8 h-full flex flex-col justify-center">
            <h1 className="text-xl lg:text-3xl font-bold text-white mb-2">{title}</h1>
            {subtitle && <p className="text-sm lg:text-base text-blue-200">{subtitle}</p>}
            <div className="flex items-center space-x-4 lg:space-x-6 mt-2 lg:mt-4 text-xs lg:text-sm text-blue-200">
              <div className="flex items-center space-x-2">
                <span>📅</span>
                <span className="hidden sm:inline">Sunday, August 10, 2025</span>
                <span className="sm:hidden">Aug 10, 2025</span>
              </div>
