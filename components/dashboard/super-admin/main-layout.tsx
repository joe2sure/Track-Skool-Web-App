...
const navigationItems = [
  ...
  { icon: GraduationCap, label: "Schools", href: "/schools", badge: "24" },
  { icon: Users, label: "Users", href: "/users", badge: "1847" },
  { icon: Shield, label: "Roles", href: "/roles", badge: "12" },
  { icon: BookOpen, label: "Courses", href: "/courses", badge: "342" },
  { icon: DollarSign, label: "Finance", href: "/finance", badge: null },
  { icon: MessageCircle, label: "Communication", href: "/communication", badge: "5" },
