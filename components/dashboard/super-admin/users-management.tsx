    ...
    <div className="space-y-4 sm:space-y-6 p-4 sm:p-0">
      ...
      <div className="text-center sm:text-left">
        ...
        <p className="text-gray-400 mt-1 sm:mt-2 text-sm sm:text-base">
          Manage all users across your educational system
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardContent className="p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-white mb-3 sm:mb-4">Role Distribution</h3>
            <div className="space-y-3 sm:space-y-4">
              {roleDistribution.map((item, index) => (
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full ${item.color}`}></div>
                    <span className="text-gray-300 text-sm sm:text-base">{item.role}</span>
                  </div>
                  <span className="text-white font-semibold text-sm sm:text-base">{item.count}</span>
                </div>
              ))}
            </div>
          </CardContent>
          ...
          <div className="flex gap-1 sm:gap-2 overflow-x-auto pb-2">
            {[
              ...
              <Button
                ...
                className={`${activeTab === tab.key ? "bg-blue-600 text-white" : "text-gray-400 hover:text-white"} text-sm whitespace-nowrap`}
                size="sm"
              >
                {tab.label}
              </Button>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 mb-1">
                      ...
                      <Badge
                        ...
                        className={`${user.status === "active" ? "bg-green-600" : "bg-gray-600"} text-xs w-fit`}
                      >
                        {user.status}
                      </Badge>
                    </div>
                    <p className="text-gray-400 text-xs sm:text-sm mb-2 truncate">{user.email}</p>
