...
export function ParentSidebar({
  ...
  return (
    <Sidebar isOpen={isOpen} className="bg-slate-900 absolute lg:sticky border-slate-700 z-40">
      <SidebarHeader className="border-b border-slate-700 bg-slate-300 h-18 flex justify-center">
        <div className="flex justify-between items-center gap-2 px-4 py-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-blue-600">Track School</span>
          </div>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <SidebarMenuItem key={item.href}>
                ...
                >
                  <Link href={item.href} onClick={onToggleSidebar}>
