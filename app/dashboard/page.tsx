              ...
              <Card>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-center p-3 bg-gray-50 dark:bg-gray-800 high-contrast:bg-gray-900 rounded-lg"
                    >
                      <div className="w-2 h-12 bg-blue-500 rounded-full mr-4"></div>
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className="font-medium text-gray-900 dark:text-white high-contrast:text-white">
                            {schedule.subject}
                          </h4>
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-300 high-contrast:text-gray-200">
                          {assignment.subject} • {assignment.due}
                        </p>
                      </div>
                    </div>
                  ))}
              ...
              <Card>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={index}
                      className="p-3 bg-blue-50 dark:bg-blue-900/20 high-contrast:bg-blue-900/30 rounded-lg"
                    >
                      <h4 className="font-medium text-blue-900 dark:text-blue-100 high-contrast:text-blue-100 text-sm">
                        {announcement.title}
                      </h4>
                      <p className="text-xs text-blue-700 dark:text-blue-300 high-contrast:text-blue-200">
                        {announcement.time}
                      </p>
                    </div>
                  ))}
              ...
              <Card>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 high-contrast:bg-gray-900 rounded-lg"
                    >
                      <h4 className="font-medium text-gray-900 dark:text-white high-contrast:text-white text-sm">
                        {event.event}
                      </h4>
                      <span className="text-xs text-gray-500 dark:text-gray-400 high-contrast:text-gray-300 bg-white dark:bg-gray-700 high-contrast:bg-gray-800 px-2 py-1 rounded">
                        {event.date}
                      </span>
                    </div>
                  ))}
        ...
        {user.userType === "parent" && (
          ...
          <div className="space-y-4">
            <Card>
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Check your child’s progress and school activities.
              </p>
            </Card>
            <Card>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
