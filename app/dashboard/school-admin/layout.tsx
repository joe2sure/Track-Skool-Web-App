...
const navigation = [
  ...
  { name: "Teachers", href: "/dashboard/school-admin/teachers", icon: GraduationCap },
  { name: "Courses", href: "/dashboard/school-admin/courses", icon: BookOpen },
  { name: "Attendance", href: "/dashboard/school-admin/attendance", icon: Calendar },
  { name: "Results", href: "/dashboard/school-admin/results", icon: BarChart3 },
  { name: "Finance", href: "/dashboard/school-admin/finance", icon: DollarSign },
  { name: "Communication", href: "/dashboard/school-admin/communication", icon: MessageSquare },
  { name: "Events", href: "/dashboard/school-admin/events", icon: CalendarDays },
          ...
          >
            <div className="flex items-center justify-center h-16 px-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-blue-600">EduAdmin</span>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between px-6 py-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="relative">
                    ...
                    <Input placeholder="Search students, teachers, courses..." className="pl-10 w-80" />
                  </div>
                </div>
