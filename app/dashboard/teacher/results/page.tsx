        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600">Monitor student performance and academic progress across all subjects</p>
            </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-green-600">+2.4% from last term</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-green-600">Above 85% grade threshold</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-red-600">Below 70% need attention</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-blue-600">This week assignments graded</p>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { subject: "Mathematics", score: 85, color: "text-blue-600" },
                    ...
                    <div key={index} className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={`text-sm font-medium ${item.color}`}>{item.score}%</span>
                      </div>
                    </div>
                  ))}
                </div>
                  ...
                  {[
                    ...
                    <div key={index} className="space-y-2">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full ${getProgressColor(item.completion)}`}
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b">
                    <tr>
                      ...
                      <th className="text-left p-4 font-medium text-gray-700">Current Grade</th>
                      <th className="text-left p-4 font-medium text-gray-700">Recent Test</th>
                      <th className="text-left p-4 font-medium text-gray-700">Assignment Status</th>
                      <th className="text-left p-4 font-medium text-gray-700">Trend</th>
                      ...
                      <tr key={student.id} className="border-b hover:bg-gray-50">
                        ...
                        <td className="p-4">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm text-gray-600">{student.gradePercentage}%</span>
                          </div>
                        </td>
                        <td className="p-4">
                          <div>
                            <p className="font-medium text-gray-900">{student.recentTest}</p>
                            <p className="text-sm text-gray-600">{student.testSubject}</p>
                          </div>
                        </td>
                        <td className="p-4">
                          <div className="flex items-center space-x-2">
                            <Badge variant="outline">{student.assignmentStatus}</Badge>
                          </div>
                        </td>
                        <td className="p-4">
                          <div
                          ...
                          >
                            <TrendingUp className={`w-4 h-4 ${student.trend === "down" ? "rotate-180" : ""}`} />
                            <span className="text-sm font-medium">{student.trendValue}</span>
                          </div>
                        </td>
                        <td className="p-4">
