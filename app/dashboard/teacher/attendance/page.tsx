...
export default function TeacherAttendance() {
  ...
  const attendanceRate = (
    ((presentCount + lateCount) / attendanceData.length) *
    100
  ).toFixed(1);
          ...
          <div className="grid gap-3 lg:gap-0 lg:flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600">
                Track and manage student attendance records for your classes
              </p>
            </div>
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="grade-10b">
                            Grade 10B - Mathematics
                          </SelectItem>
                          <SelectItem value="grade-11a">
                            Grade 11A - Algebra
                          </SelectItem>
                          <SelectItem value="grade-11b">
                            Grade 11B - Algebra
                          </SelectItem>
                          <SelectItem value="grade-12a">
                            Grade 12A - Calculus
                          </SelectItem>
                        </SelectContent>
                      </Select>
