...
const subjectBreakdown = [
  { subject: "Physics", completed: 4, total: 4, grade: "A+", color: "bg-blue-600" },
  { subject: "Chemistry", completed: 3, total: 4, grade: "A", color: "bg-green-600" },
  { subject: "Literature", completed: 3, total: 4, grade: "A-", color: "bg-purple-600" },
  { subject: "Mathematics", completed: 2, total: 3, grade: "A", color: "bg-orange-600" },
]
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400 mt-1">View homework, projects, and submission status for your children</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                <CardTitle className="text-white">Assignment Statistics</CardTitle>
              </div>
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <h4 className="text-white font-medium mb-3">Completion Rate</h4>
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-slate-400">12 of 15 assignments completed</p>
                  </div>
                </div>
                <div>
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-slate-400 text-sm">Excellent performance across all subjects</p>
                  </div>
                </div>
              </div>
            </CardContent>
              ...
              {subjectBreakdown.map((subject, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-slate-700 rounded-lg">
                  ...
                  <div className="text-right">
                    <Badge className={`${subject.color} text-white mb-1`}>{subject.grade}</Badge>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader className="flex flex-row items-center justify-between">
              <CardTitle className="text-white">Assignment List</CardTitle>
              <div className="flex gap-2">
                <Button size="sm" className="bg-blue-600 hover:bg-blue-700">
                  Emma (Grade 5)
                </Button>
                ...
                <div key={assignment.id} className="p-4 bg-slate-700 rounded-lg">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <div className="mt-2">
                        <span className="text-xs text-slate-400">Submission Type:</span>
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-7 gap-1">
                {calendarDays.map((day) => {
                  const hasAssignment = assignmentDates[day as keyof typeof assignmentDates]
                  return (
                    <div
                      key={day}
              ...
              <div className="mt-4 space-y-2">
                <h4 className="text-white font-medium text-sm">Assignment Status</h4>
              ...
              <div className="mt-4 p-3 bg-slate-700 rounded-lg">
                <h4 className="text-white font-medium text-sm mb-1">Upcoming This Week</h4>
                <p className="text-slate-400 text-xs">No assignments due this week</p>
              </div>
            </CardContent>
          </Card>
        </div>
