      ...
      <div className="bg-white/90 dark:bg-gray-800/90 high-contrast:bg-black/95 backdrop-blur-sm rounded-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 high-contrast:text-gray-200 mt-2">
            Sign in to your SkoolBridge account
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="relative">
              ...
              >
                <i
                  ...
                  } text-gray-400 text-sm w-4 h-4 flex items-center justify-center`}
                ></i>
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <label
                htmlFor="remember-me"
                className="ml-2 block text-sm text-gray-700 dark:text-gray-300 high-contrast:text-white cursor-pointer"
              >
                Remember me
              </label>
            </div>
